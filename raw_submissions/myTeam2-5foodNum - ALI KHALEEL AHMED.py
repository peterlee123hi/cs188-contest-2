...
class OffensiveAgent(CaptureAgent):
  ...
  def chooseAction(self,gameState):
    ...
    if self.foodNum >= 5:
      ...
      # print "finalConsiderations", finalConsiderations
  ...
  def getWeights(self, gameState, action):
    ...
    'normalGhosts': -30, 'eatGhost': 1.0, 'scaredGhosts': 0.1, 'stuck': -15, 'eatFood': 1, 'pathOnExitRoute': 10, 'closeToExitPos': -15, 'repeatMovement': -1}
