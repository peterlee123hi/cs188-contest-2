...
class OffenseAgent(CaptureAgent):
  ...
  def chooseAction(self, gameState):
    ...
    print 'eval time for agent %d: %.4f' % (self.index, timeTaken)
    if timeTaken > 1:
      print "WARNING YOU BETTER WATCH OUT MAN"
      self.warningWatch += 1
  ...
  def evaluate(self, gameState):
    ...
    a = features * weights
    if self.printing:
      print 'successorScore: ', features['successorScore'], ' * ', weights['successorScore']
      print 'distanceToFood: ', features['distanceToFood'], ' * ', weights['distanceToFood']
      print 'distanceToBuddy: ', features['distanceToBuddy'], ' * ', weights['distanceToBuddy']
      print 'distanceHome: ', features['distanceHome'], ' * ', weights['distanceHome']
      print 'threatDistance: ', features['threatDistance'], ' * ', weights['threatDistance']
      print 'capsules', features['capsules'], ' * ', weights['capsules']
      print 'empowerment: ', features['empowerment'], ' * ', weights['empowerment']
      print 'security: ', features['security'], ' * ', weights['security']
      print 'total: ', a
    return a
