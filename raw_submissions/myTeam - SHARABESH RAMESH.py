...
class ReflexCaptureAgent(CaptureAgent):
  ...
  """
    ...
    """
        ...
        # print("CURRENT ONE IS {0}".format(self.index))
        ...
        # print "ALPHA BETA RETURNED {0}".format(alphaB_val)
...
class OffensiveReflexAgent(ReflexCaptureAgent):
  ...
  """
    ...
    """
        ...
        maxValue = max(values)
        bestActions = [a for a, v in zip(actions, values) if v == maxValue]
        print "BESTACTIONS ARE {0}".format(bestActions)
        ...
        print "COST WAS {0}".format(maxValue)
